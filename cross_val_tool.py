...
class cross_validation(object):
    ...
    def validate_for_holdout_set(self, X_holdout, Y_holdout):
        '''Cross validates model on holdout set and stores results for learning curve plots'''
    ...
    def plot_learning_curve(self):
        '''Plots accuracy, precision, recall, and f1 score learning curves for a given model and data set'''
